...
function Weather() {
  ...
  const API_KEY="58b8dd49bfaf6b405877d71e624b52f6";
  ...
  async function fetchData(){
    try{
      ...
      if(response.ok){
        ...
        setError('No Data found.Please enter the valid city name')
      }
    }
    catch (error){
  ...
  return (
    ...
    <div children className='city'>
    <input type="text" value={city} onChange={handleOnChange} placeholder='Enter the city'></input>
